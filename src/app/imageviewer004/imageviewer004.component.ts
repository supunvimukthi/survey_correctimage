...
@Component({
  selector: 'app-imageviewer004',
  templateUrl: './imageviewer004.component.html',
  styleUrls: ['./imageviewer004.component.css']
})

export class Imageviewer004Component implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient) {
    if(this.router.getCurrentNavigation().extras.state==undefined){
      ...
      localStorage.setItem("batch004",this.batch);
    }
  ...
  async listObjects() {
    let count=0;
    this.http.get("https://storage.googleapis.com/storage/v1/b/research-kr-2020/o?prefix=celeb/batch_"+this.batch)
      .subscribe((data: any) => {
