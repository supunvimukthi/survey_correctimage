...
@Component({
  selector: 'app-imageviewer003',
  templateUrl: './imageviewer003.component.html',
  styleUrls: ['./imageviewer003.component.css']
})

export class Imageviewer003Component implements OnInit {
