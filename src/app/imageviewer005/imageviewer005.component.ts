...
@Component({
  selector: 'app-imageviewer005',
  templateUrl: './imageviewer005.component.html',
  styleUrls: ['./imageviewer005.component.css']
})
export class Imageviewer005Component implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient) {
    if(this.router.getCurrentNavigation().extras.state==undefined){
      ...
      localStorage.setItem("batch005",this.batch);
    }
  ...
  async listObjects() {
    let count=0;
    this.http.get("https://storage.googleapis.com/storage/v1/b/research-kr-2020/o?prefix=facade/batch_"+this.batch)
      .subscribe((data: any) => {
