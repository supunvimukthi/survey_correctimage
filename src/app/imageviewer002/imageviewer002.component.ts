...
@Component({
  selector: 'app-imageviewer002',
  templateUrl: './imageviewer002.component.html',
  styleUrls: ['./imageviewer002.component.css']
})

export class Imageviewer002Component implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient) {
    if(this.router.getCurrentNavigation().extras.state==undefined){
      ...
      localStorage.setItem("batch002",this.batch);
    }
  ...
  async listObjects() {
    let count=0;
    this.http.get("https://storage.googleapis.com/storage/v1/b/research-kr-2020/o?prefix=Method_comparison/batch_"+this.batch)
      .subscribe((data: any) => {
